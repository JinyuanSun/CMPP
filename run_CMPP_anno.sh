...
hmmscan --tblout $FASTA.p450.htb --noali --cpu 4 -E 1e-5 $PATH_TO_FUNCDB/P450/P450.hmm.txt $FASTA
hmmscan --tblout $FASTA.cazy.htb --noali --cpu 4 -E 1e-5 $PATH_TO_FUNCDB/CAZy/dbCAN-HMMdb-V9.txt $FASTA
